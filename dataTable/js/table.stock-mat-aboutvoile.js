...
$(document).ready(function() {
    ...
    if (editable == 1) {
        var editor = new $.fn.dataTable.Editor( {
            ajax: 'php/table.stock-mat-aboutvoile.php/?fecha='+fecha,
            table: '#ABOUTVOILE',
            fields: [
                {
...
// Setup - add a text input to each footer cell
	...
	var table = $('#ABOUTVOILE').DataTable( {
		...
		columns: [
			...
			{
				"data": "sen_stock_mat.sec_a4_spain"
			},
			{
				"data": "sen_stock_mat.poutre_ha8_spain"
			},
			{
				"data": "sen_stock_mat.poutre_ha10_spain"
			}
		],
		paging: false,
		searching: false,
