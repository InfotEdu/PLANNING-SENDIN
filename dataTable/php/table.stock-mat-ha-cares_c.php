...
Editor::inst( $db, 'sen_stock_mat', 'id' )
	->fields(
        ...
        Field::inst( 'sen_stock_mat.d8_cares_c' ),
        Field::inst( 'sen_stock_mat.d10_cares_c' ),
        Field::inst( 'sen_stock_mat.d12_cares_c' ),
        Field::inst( 'sen_stock_mat.d14_cares_c' ),
        Field::inst( 'sen_stock_mat.d16_cares_c' ),
        Field::inst( 'sen_stock_mat.d20_cares_c' ),
        Field::inst( 'sen_stock_mat.d25_cares_c' ),
        Field::inst( 'sen_stock_mat.d32_cares_c' ),
		Field::inst( 'sen_stock_mat.d40_cares_c' ),
