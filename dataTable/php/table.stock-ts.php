...
Editor::inst( $db, 'sen_stock', 'id' )
	->fields(
		...
		Field::inst( 'sen_stock.colis_chilly' ),
		Field::inst( 'sen_stock.poids_chilly' ),
		Field::inst( 'sen_stock.colis_spain' ),
		Field::inst( 'sen_stock.poids_spain' ),
		Field::inst( 'sen_stock.kg_paquete' )
	)
	->where( 'sen_stock.id_familia', 1 )
