...
Editor::inst( $db, 'sen_stock_mat', 'id' )
	->fields(
        ...
        Field::inst( 'sen_stock_mat.d8_cares_chilly' ),
        Field::inst( 'sen_stock_mat.d10_cares_chilly' ),
        Field::inst( 'sen_stock_mat.d12_cares_chilly' ),
        Field::inst( 'sen_stock_mat.d14_cares_chilly' ),
        Field::inst( 'sen_stock_mat.d16_cares_chilly' ),
        Field::inst( 'sen_stock_mat.d20_cares_chilly' ),
        Field::inst( 'sen_stock_mat.d25_cares_chilly' ),
        Field::inst( 'sen_stock_mat.d32_cares_chilly' ),
		Field::inst( 'sen_stock_mat.d40_cares_chilly' ),
