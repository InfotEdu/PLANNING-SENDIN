		...
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-ha-cares-chilly.js"></script>
		<!-- 	QUITADO SEPT 2024 <script type="text/javascript" charset="utf-8" src="js/table.stock-mat-ha-cares-chilly_c.js"></script> -->
			...
			$( document ).ready(function() {
				...
				$( "#enviar-email" ).click(function() {
				  // Assign handlers immediately after making the request,
					...
					var jqxhr = $.get( "<?=base_url('/public/informes/enviar-informe-stock-cares-chilly.php?fecha='.$fecha)?>", function() {
					 
					})
					  .done(function() {
					    dialog.init(function(){
					    	dialog.find('.bootbox-body').html('Le rapport a été envoyé avec succès. aaznar@sendin.com, jlafuente@sendin.com, dmolina@sendin.com, l.besnard@sendin.com,s.sendin@sendin.com, desarrolloweb@infoter.net');
						});
					  })
					  .fail(function() {
					    dialog.init(function(){
