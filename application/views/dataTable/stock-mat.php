		...
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-ha.js"></script>
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-adx.js"></script>
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-trellis.js"></script>
<!-- 		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-couplers.js"></script> -->
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-attentes.js"></script>
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-aboutvoile.js"></script> 
		...
		<script type="text/javascript">
			$(document).ready(function()
			{
				...
				$( "#bobinasIdea" ).change(function() {
				  ...
				  $.ajax({
				    type:'POST',
				    data:{ unidades: valorRecogido, lugar: 'd6_spain', fecha: '<?=$fecha?>'},
				    url:'<?php echo base_url('dataTable/StockMAT/GuardaBIdea');?>',
				...
				$( "#enviar-email" ).click(function() {
				  // Assign handlers immediately after making the request,
					...
					var jqxhr = $.get( "<?=base_url('/public/informes/enviar-informe-stock-spain.php?fecha='.$fecha)?>", function() {
					 
					})
					  .done(function() {
					    dialog.init(function(){
					    	dialog.find('.bootbox-body').html('Le rapport a été envoyé avec succès.  jlafuente@sendin.com, dmolina@sendin.com, l.besnard@sendin.com,s.sendin@sendin.com, produccion@sendin.com');
						});
					  })
					  .fail(function() {
					    dialog.init(function(){
		...
		<div style="background: #fff; padding: 2%; border-radius: 20px; z-index: 999; position: absolute; width: 85%;">
			...
			<h1 style="max-width:50%; float: left;">
					Stock Material Spain <?php echo $fecha?> <!-- (editable=<?php echo $editable?>) <a href="/public/informes/informe-stock-spain.php?fecha=<?=$fecha?>" target="_blank"> Ver PDF </a>-->
			</h1>

			<a style="float: left; margin-left: 15px; color: #000000 !important;" href="/public/informes/informe-stock-spain.php?fecha=<?=$fecha?>" target="_blank">  <button style="max-width: 220px;" type="button" class="btn btn-block btn-outline-primary btn-lg">Ver PDF </button>  </a>
			...
			<input class="labelIdea" id="bobinasIdea" type="number" name="bobinasIdea" value="<?=$bobinasIdea["d6_spain"]?>">
