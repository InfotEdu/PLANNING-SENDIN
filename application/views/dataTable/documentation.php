		...
		<script type="text/javascript" charset="utf-8" src="js/table.documentation.js"></script>
		<div style="background: #fff; padding: 2%; border-radius: 20px; z-index: 999; position: absolute; width: 90%;">
			<h1>
				<?php
				    ...
				    if ($id_origen == 1) {
				    	echo ("Documentation: Spain - Usine teruel");
				    } else if ($id_origen == 2){
						echo ("Documentation: Express - Usine Mazarin");
				    } else if ($id_origen == 3){
						echo ("Documentation: Manchons");
				    } else if ($id_origen == 4){
						echo ("Documentation: Stock Actuels");
				    }
				?>

			</h1>
			<div style="overflow-x:auto;">
			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="documentation" width="100%">
				<thead>
					<tr>
						<th>Nombre</th>
						<th>Ver documento</th>
