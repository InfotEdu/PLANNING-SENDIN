		...
		<script type="text/javascript" charset="utf-8" src="js/table.stock-ts.js"></script>
		<div style="background: #fff; padding: 2%; border-radius: 20px; z-index: 999; position: absolute; width: 85%;">
			<h1>
				Stocks Actuels - Treillis Soudés Standard
			</h1>
			<div style="overflow-x:auto;">
			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="stock" width="100%">
				<thead>
					<tr>
						<th>Type</th>
						<th>Colis Chilly</th>
