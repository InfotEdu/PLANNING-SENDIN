		...
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-historico.js"></script>
		...
		<div style="background: #fff; padding: 2%; border-radius: 20px; z-index: 999; position: absolute; width: 85%;">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="HISTORICO" width="100%">
				<thead>
					<tr>
						<th>Fecha</th>
						<th>SPAIN</th>
