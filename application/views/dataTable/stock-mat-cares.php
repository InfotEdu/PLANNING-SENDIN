		...
		<script type="text/javascript" charset="utf-8" src="js/table.stock-mat-ha-cares.js"></script>
		<!-- 	QUITADO SEPT 2024 <script type="text/javascript" charset="utf-8" src="js/table.stock-mat-ha-cares_c.js"></script> -->
			...
			$( document ).ready(function() {
				...
				$( "#enviar-email" ).click(function() {
				  // Assign handlers immediately after making the request,
					...
					var jqxhr = $.get( "<?=base_url('/public/informes/enviar-informe-stock-cares.php?fecha='.$fecha)?>", function() {
