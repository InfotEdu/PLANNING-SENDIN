  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body with-border">
        <div class="col-md-6">
          <h4><i class="fa fa-plus"></i> &nbsp; Ajouter un nouvel utilisateur</h4>
        </div>
        <div class="col-md-6 text-right">
          <a href="<?= base_url('admin/users'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Liste des utilisateurs</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/users/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                <label for="role" class="col-sm-2 control-label">Sélectionnez un groupe</label>
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Ajouter un utilisateur" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
