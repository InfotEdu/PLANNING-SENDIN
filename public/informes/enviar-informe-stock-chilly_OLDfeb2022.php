...
$sumCold6 = $filasHA[0]['d6_chilly'] + $filasHA[1]['d6_chilly'] +$filasHA[2]['d6_chilly'] +$filasHA[3]['d6_chilly'] +$filasHA[4]['d6_chilly'];
$sumCold8 = $filasHA[0]['d8_chilly'] + $filasHA[1]['d8_chilly'] +$filasHA[2]['d8_chilly'] +$filasHA[3]['d8_chilly'] +$filasHA[4]['d8_chilly'];
$sumCold9 = $filasHA[0]['d9_chilly'] + $filasHA[1]['d9_chilly'] +$filasHA[2]['d9_chilly'] +$filasHA[3]['d9_chilly'] +$filasHA[4]['d9_chilly'];
$sumCold10 = $filasHA[0]['d10_chilly'] + $filasHA[1]['d10_chilly'] +$filasHA[2]['d10_chilly'] +$filasHA[3]['d10_chilly'] +$filasHA[4]['d10_chilly'];
$sumCold12 = $filasHA[0]['d12_chilly'] + $filasHA[1]['d12_chilly'] +$filasHA[2]['d12_chilly'] +$filasHA[3]['d12_chilly'] +$filasHA[4]['d12_chilly'];
$sumCold14 = $filasHA[0]['d14_chilly'] + $filasHA[1]['d14_chilly'] +$filasHA[2]['d14_chilly'] +$filasHA[3]['d14_chilly'] +$filasHA[4]['d14_chilly'];
$sumCold16 = $filasHA[0]['d16_chilly'] + $filasHA[1]['d16_chilly'] +$filasHA[2]['d16_chilly'] +$filasHA[3]['d16_chilly'] +$filasHA[4]['d16_chilly'];
$sumCold20 = $filasHA[0]['d20_chilly'] + $filasHA[1]['d20_chilly'] +$filasHA[2]['d20_chilly'] +$filasHA[3]['d20_chilly'] +$filasHA[4]['d20_chilly'];
$sumCold25 = $filasHA[0]['d25_chilly'] + $filasHA[1]['d25_chilly'] +$filasHA[2]['d25_chilly'] +$filasHA[3]['d25_chilly'] +$filasHA[4]['d25_chilly'];
$sumCold32 = $filasHA[0]['d32_chilly'] + $filasHA[1]['d32_chilly'] +$filasHA[2]['d32_chilly'] +$filasHA[3]['d32_chilly'] +$filasHA[4]['d32_chilly'];
$sumCold40 = $filasHA[0]['d40_chilly'] + $filasHA[1]['d40_chilly'] +$filasHA[2]['d40_chilly'] +$filasHA[3]['d40_chilly'] +$filasHA[4]['d40_chilly'];
...
//TABLA UNITES COUPLERS
$totalColumnaFila = 0;
//CABECERA TABLA
$pdf->SetFillColor(69,185,68);
$pdf->Cell(74,4,utf8_decode('UNITES COUPLERS'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('C12'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('C14'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('C16'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('C20'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('C26'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('C32'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('C40'),'LTBR',0,'C',TRUE);
...
//FILA TABLA
$pdf->SetFont('Helvetica','',9);
$pdf->Cell(74,4,utf8_decode('STOCK  M-1'),'LTBR',0,'R');
$pdf->Cell(17,4,utf8_decode($filasCouplers[0]['c12_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[0]['c14_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[0]['c16_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[0]['c20_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[0]['c26_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[0]['c32_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[0]['c40_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$totalFila =  $filasCouplers[0]['c12_chilly'] + $filasCouplers[0]['c14_chilly'] + $filasCouplers[0]['c16_chilly'] + $filasCouplers[0]['c20_chilly'] + $filasCouplers[0]['c26_chilly'] +
$filasCouplers[0]['c32_chilly'] +
$filasCouplers[0]['c40_chilly'];
$totalColumnaFila = $totalColumnaFila + $totalFila;
...
//FILA TABLA
$pdf->SetFont('Helvetica','',9);
$pdf->Cell(74,4,utf8_decode('LIVRAISONS'),'LTBR',0,'R');
$pdf->Cell(17,4,utf8_decode($filasCouplers[1]['c12_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[1]['c14_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[1]['c16_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[1]['c20_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[1]['c26_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[1]['c32_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasCouplers[1]['c40_chilly']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C');
$totalFila =  $filasCouplers[1]['c12_chilly'] + $filasCouplers[1]['c14_chilly'] + $filasCouplers[1]['c16_chilly'] + $filasCouplers[1]['c20_chilly'] + $filasCouplers[1]['c26_chilly'] +
$filasCouplers[1]['c32_chilly'] +
$filasCouplers[1]['c40_chilly'];
$totalColumnaFila = $totalColumnaFila + $totalFila;
$pdf->SetFillColor(69,185,68);
$pdf->Cell(17,4,utf8_decode($totalFila),'LTBR',1,'C',TRUE);

//CALCULO SUMATORIOS COLUMNA
$sumCold6 = $filasCouplers[0]['c12_chilly'] + $filasCouplers[1]['c12_chilly'] ;
$sumCold8 = $filasCouplers[0]['c14_chilly'] + $filasCouplers[1]['c14_chilly'] ;
$sumCold9 = $filasCouplers[0]['c16_chilly'] + $filasCouplers[1]['c16_chilly'] ;
$sumCold10 = $filasCouplers[0]['c20_chilly'] + $filasCouplers[1]['c20_chilly'] ;
$sumCold12 = $filasCouplers[0]['c26_chilly'] + $filasCouplers[1]['c26_chilly'] ;
$sumCold14 = $filasCouplers[0]['c32_chilly'] + $filasCouplers[1]['c32_chilly'] ;
$sumCold16 = $filasCouplers[0]['c40_chilly'] + $filasCouplers[1]['c40_chilly'] ;
$totalFila = 0; 
$totalFila = $sumCold6 + $sumCold8 + $sumCold9 + $sumCold10 + $sumCold12 + $sumCold14 + $sumCold16;



//PIE TABLA
$pdf->SetFont('Helvetica','B',9);
$pdf->Cell(74,4,utf8_decode('STOCK ACTUEL'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode($sumCold6),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode($sumCold8),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode($sumCold9),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode($sumCold10),'LTBR',0,'C',TRUE);
...
$pdf->SetFont('Helvetica','B',9);
$pdf->Cell(74,4,utf8_decode('CONSO'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('0,0'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('0,0'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('0,0'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('0,0'),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode('0,0'),'LTBR',0,'C',TRUE);
...
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode(''),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,utf8_decode(''),'LTBR',1,'C',TRUE);
