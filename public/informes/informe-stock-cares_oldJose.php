...
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d8_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d10_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d12_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d14_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d16_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d20_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d25_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d32_cares']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d40_cares']),'LTBR',0,'C');
$totalFila =   $filasHA[1]['d8_cares'] + $filasHA[1]['d10_cares'] + $filasHA[1]['d12_cares'] +
$filasHA[1]['d14_cares'] +
$filasHA[1]['d16_cares'] +
$filasHA[1]['d20_cares'] +
$filasHA[1]['d25_cares'] +
...
$sumCold8 = $filasHA[0]['d8_cares'] + $filasHA[1]['d8_cares'] +$filasHA[1]['d8_cares'] +$filasHA[2]['d8_cares'] +$filasHA[4]['d8_cares'];
$sumCold10 = $filasHA[0]['d10_cares'] + $filasHA[1]['d10_cares'] +$filasHA[1]['d10_cares'] +$filasHA[2]['d10_cares'] +$filasHA[4]['d10_cares'];
$sumCold12 = $filasHA[0]['d12_cares'] + $filasHA[1]['d12_cares'] +$filasHA[1]['d12_cares'] +$filasHA[2]['d12_cares'] +$filasHA[4]['d12_cares'];
$sumCold14 = $filasHA[0]['d14_cares'] + $filasHA[1]['d14_cares'] +$filasHA[1]['d14_cares'] +$filasHA[2]['d14_cares'] +$filasHA[4]['d14_cares'];
$sumCold16 = $filasHA[0]['d16_cares'] + $filasHA[1]['d16_cares'] +$filasHA[1]['d16_cares'] +$filasHA[2]['d16_cares'] +$filasHA[4]['d16_cares'];
$sumCold20 = $filasHA[0]['d20_cares'] + $filasHA[1]['d20_cares'] +$filasHA[1]['d20_cares'] +$filasHA[2]['d20_cares'] +$filasHA[4]['d20_cares'];
$sumCold25 = $filasHA[0]['d25_cares'] + $filasHA[1]['d25_cares'] +$filasHA[1]['d25_cares'] +$filasHA[2]['d25_cares'] +$filasHA[4]['d25_cares'];
$sumCold32 = $filasHA[0]['d32_cares'] + $filasHA[1]['d32_cares'] +$filasHA[1]['d32_cares'] +$filasHA[2]['d32_cares'] +$filasHA[4]['d32_cares'];
$sumCold40 = $filasHA[0]['d40_cares'] + $filasHA[1]['d40_cares'] +$filasHA[1]['d40_cares'] +$filasHA[2]['d40_cares'] +$filasHA[4]['d40_cares'];
...
$sumCold8 = ($filasHA[1]['d8_cares'] * $filasHA[1]['peso_d8']) + ($filasHA[1]['d8_cares'] * $filasHA[1]['peso_d8']) + ($filasHA[2]['d8_cares'] * $filasHA[2]['peso_d8']) + ($filasHA[4]['d8_cares'] * $filasHA[4]['peso_d8']) ;
$sumCold10 = ($filasHA[1]['d10_cares'] * $filasHA[1]['peso_d10']) + ($filasHA[1]['d10_cares'] * $filasHA[1]['peso_d10']) + ($filasHA[2]['d10_cares'] * $filasHA[2]['peso_d10']) + ($filasHA[4]['d10_cares'] * $filasHA[4]['peso_d10']) ;
$sumCold12 = ($filasHA[1]['d12_cares'] * $filasHA[1]['peso_d12']) + ($filasHA[1]['d12_cares'] * $filasHA[1]['peso_d12']) + ($filasHA[2]['d12_cares'] * $filasHA[2]['peso_d12']) + ($filasHA[4]['d12_cares'] * $filasHA[4]['peso_d12']) ;
$sumCold14 = ($filasHA[1]['d14_cares'] * $filasHA[1]['peso_d14']) + ($filasHA[1]['d14_cares'] * $filasHA[1]['peso_d14']) + ($filasHA[2]['d14_cares'] * $filasHA[2]['peso_d14']) + ($filasHA[4]['d14_cares'] * $filasHA[4]['peso_d14']) ;
$sumCold16 = ($filasHA[1]['d16_cares'] * $filasHA[1]['peso_d16']) + ($filasHA[1]['d16_cares'] * $filasHA[1]['peso_d16']) + ($filasHA[2]['d16_cares'] * $filasHA[2]['peso_d16']) + ($filasHA[4]['d16_cares'] * $filasHA[4]['peso_d16']) ;
$sumCold20 = ($filasHA[1]['d20_cares'] * $filasHA[1]['peso_d20']) + ($filasHA[1]['d20_cares'] * $filasHA[1]['peso_d20']) + ($filasHA[2]['d20_cares'] * $filasHA[2]['peso_d20']) + ($filasHA[4]['d20_cares'] * $filasHA[4]['peso_d20']) ;
$sumCold25 = ($filasHA[1]['d25_cares'] * $filasHA[1]['peso_d25']) + ($filasHA[1]['d25_cares'] * $filasHA[1]['peso_d25']) + ($filasHA[2]['d25_cares'] * $filasHA[2]['peso_d25']) + ($filasHA[4]['d25_cares'] * $filasHA[4]['peso_d25']) ;
$sumCold32 = ($filasHA[1]['d32_cares'] * $filasHA[1]['peso_d32']) + ($filasHA[1]['d32_cares'] * $filasHA[1]['peso_d32']) + ($filasHA[2]['d32_cares'] * $filasHA[2]['peso_d32']) + ($filasHA[4]['d32_cares'] * $filasHA[4]['peso_d32']) ;
$sumCold40 = ($filasHA[1]['d40_cares'] * $filasHA[1]['peso_d40']) + ($filasHA[1]['d40_cares'] * $filasHA[1]['peso_d40']) + ($filasHA[2]['d40_cares'] * $filasHA[2]['peso_d40']) + ($filasHA[4]['d40_cares'] * $filasHA[4]['peso_d40']) ;
$totalFila = 0; 
$totalFila =  $sumCold8 + $sumCold10 + $sumCold12 + $sumCold14 + $sumCold16+ $sumCold20+ $sumCold25+ $sumCold32+ $sumCold40;
...
$pdf->SetFont('Helvetica','',9);
$pdf->Cell(74,4,utf8_decode('BARRAS 12 M'),'LTBR',0,'R');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d8_cares'] * $filasHA[1]['peso_d8']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d10_cares'] * $filasHA[1]['peso_d10']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d12_cares'] * $filasHA[1]['peso_d12']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d14_cares'] * $filasHA[1]['peso_d14']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d16_cares'] * $filasHA[1]['peso_d16']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d20_cares'] * $filasHA[1]['peso_d20']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d25_cares'] * $filasHA[1]['peso_d25']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d32_cares'] * $filasHA[1]['peso_d32']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA[1]['d40_cares'] * $filasHA[1]['peso_d40']),'LTBR',0,'C');

$totalFila =  
($filasHA[1]['d8_cares'] * $filasHA[1]['peso_d8']) +
($filasHA[1]['d10_cares'] * $filasHA[1]['peso_d10']) +
($filasHA[1]['d12_cares'] * $filasHA[1]['peso_d12']) +
($filasHA[1]['d14_cares'] * $filasHA[1]['peso_d14']) +
($filasHA[1]['d16_cares'] * $filasHA[1]['peso_d16']) +
($filasHA[1]['d20_cares'] * $filasHA[1]['peso_d20']) +
($filasHA[1]['d25_cares'] * $filasHA[1]['peso_d25']) +
($filasHA[1]['d32_cares'] * $filasHA[1]['peso_d32']) +
($filasHA[1]['d40_cares'] * $filasHA[1]['peso_d40']);
...
//CALCULO SUMATORIOS COLUMNA
$sumCold8 = ($filasHA[0]['d8_cares'] * $filasHA[0]['peso_d8']) + ($filasHA[1]['d8_cares'] * $filasHA[1]['peso_d8']) + ($filasHA[1]['d8_cares'] * $filasHA[1]['peso_d8']) + ($filasHA[2]['d8_cares'] * $filasHA[2]['peso_d8']) + ($filasHA[4]['d8_cares'] * $filasHA[4]['peso_d8']) ;
$sumCold10 = ($filasHA[0]['d10_cares'] * $filasHA[0]['peso_d10']) + ($filasHA[1]['d10_cares'] * $filasHA[1]['peso_d10']) + ($filasHA[1]['d10_cares'] * $filasHA[1]['peso_d10']) + ($filasHA[2]['d10_cares'] * $filasHA[2]['peso_d10']) + ($filasHA[4]['d10_cares'] * $filasHA[4]['peso_d10']) ;
$sumCold12 = ($filasHA[0]['d12_cares'] * $filasHA[0]['peso_d12']) + ($filasHA[1]['d12_cares'] * $filasHA[1]['peso_d12']) + ($filasHA[1]['d12_cares'] * $filasHA[1]['peso_d12']) + ($filasHA[2]['d12_cares'] * $filasHA[2]['peso_d12']) + ($filasHA[4]['d12_cares'] * $filasHA[4]['peso_d12']) ;
$sumCold14 = ($filasHA[0]['d14_cares'] * $filasHA[0]['peso_d14']) + ($filasHA[1]['d14_cares'] * $filasHA[1]['peso_d14']) + ($filasHA[1]['d14_cares'] * $filasHA[1]['peso_d14']) + ($filasHA[2]['d14_cares'] * $filasHA[2]['peso_d14']) + ($filasHA[4]['d14_cares'] * $filasHA[4]['peso_d14']) ;
$sumCold16 = ($filasHA[0]['d16_cares'] * $filasHA[0]['peso_d16']) + ($filasHA[1]['d16_cares'] * $filasHA[1]['peso_d16']) + ($filasHA[1]['d16_cares'] * $filasHA[1]['peso_d16']) + ($filasHA[2]['d16_cares'] * $filasHA[2]['peso_d16']) + ($filasHA[4]['d16_cares'] * $filasHA[4]['peso_d16']) ;
$sumCold20 = ($filasHA[0]['d20_cares'] * $filasHA[0]['peso_d20']) + ($filasHA[1]['d20_cares'] * $filasHA[1]['peso_d20']) + ($filasHA[1]['d20_cares'] * $filasHA[1]['peso_d20']) + ($filasHA[2]['d20_cares'] * $filasHA[2]['peso_d20']) + ($filasHA[4]['d20_cares'] * $filasHA[4]['peso_d20']) ;
$sumCold25 = ($filasHA[0]['d25_cares'] * $filasHA[0]['peso_d25']) + ($filasHA[1]['d25_cares'] * $filasHA[1]['peso_d25']) + ($filasHA[1]['d25_cares'] * $filasHA[1]['peso_d25']) + ($filasHA[2]['d25_cares'] * $filasHA[2]['peso_d25']) + ($filasHA[4]['d25_cares'] * $filasHA[4]['peso_d25']) ;
$sumCold32 = ($filasHA[0]['d32_cares'] * $filasHA[0]['peso_d32']) + ($filasHA[1]['d32_cares'] * $filasHA[1]['peso_d32']) + ($filasHA[1]['d32_cares'] * $filasHA[1]['peso_d32']) + ($filasHA[2]['d32_cares'] * $filasHA[2]['peso_d32']) + ($filasHA[4]['d32_cares'] * $filasHA[4]['peso_d32']) ;
$sumCold40 = ($filasHA[0]['d40_cares'] * $filasHA[0]['peso_d40']) + ($filasHA[1]['d40_cares'] * $filasHA[1]['peso_d40']) + ($filasHA[1]['d40_cares'] * $filasHA[1]['peso_d40']) + ($filasHA[2]['d40_cares'] * $filasHA[2]['peso_d40']) + ($filasHA[4]['d40_cares'] * $filasHA[4]['peso_d40']) ;
$totalFila = 0; 
$totalFila = $sumCold6 + $sumCold8 + $sumCold9 + $sumCold10 + $sumCold12 + $sumCold14 + $sumCold16+ $sumCold20+ $sumCold25+ $sumCold32+ $sumCold40;
...
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d8'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d10'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d12'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d14'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d16'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d20'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d25'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d32'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['d40'].' days')),'LTBR',0,'C',TRUE);
$pdf->Cell(17,4,date('d/m/Y', strtotime(' + '.$diasStock['total'].' days')),'LTBR',1,'C',TRUE);
...
$pdf->SetFont('Helvetica','',9);
$pdf->Cell(74,4,utf8_decode('BARRAS 12 M'),'LTBR',0,'R');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d8_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d10_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d12_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d14_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d16_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d20_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d25_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d32_cares_c']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d40_cares_c']),'LTBR',0,'C');
$totalFila =   $filasHA_c[1]['d8_cares_c'] + $filasHA_c[1]['d10_cares_c'] + $filasHA_c[1]['d12_cares_c'] +
$filasHA_c[1]['d14_cares_c'] +
$filasHA_c[1]['d16_cares_c'] +
$filasHA_c[1]['d20_cares_c'] +
$filasHA_c[1]['d25_cares_c'] +
$filasHA_c[1]['d32_cares_c'] +
$filasHA_c[1]['d40_cares_c'];
...
//CALCULO SUMATORIOS COLUMNA
$sumCold8 = $filasHA_c[0]['d8_cares_c'] + $filasHA_c[1]['d8_cares_c'] +$filasHA_c[1]['d8_cares_c'] +$filasHA_c[2]['d8_cares_c'] +$filasHA_c[4]['d8_cares_c'];
$sumCold10 = $filasHA_c[0]['d10_cares_c'] + $filasHA_c[1]['d10_cares_c'] +$filasHA_c[1]['d10_cares_c'] +$filasHA_c[2]['d10_cares_c'] +$filasHA_c[4]['d10_cares_c'];
$sumCold12 = $filasHA_c[0]['d12_cares_c'] + $filasHA_c[1]['d12_cares_c'] +$filasHA_c[1]['d12_cares_c'] +$filasHA_c[2]['d12_cares_c'] +$filasHA_c[4]['d12_cares_c'];
$sumCold14 = $filasHA_c[0]['d14_cares_c'] + $filasHA_c[1]['d14_cares_c'] +$filasHA_c[1]['d14_cares_c'] +$filasHA_c[2]['d14_cares_c'] +$filasHA_c[4]['d14_cares_c'];
$sumCold16 = $filasHA_c[0]['d16_cares_c'] + $filasHA_c[1]['d16_cares_c'] +$filasHA_c[1]['d16_cares_c'] +$filasHA_c[2]['d16_cares_c'] +$filasHA_c[4]['d16_cares_c'];
$sumCold20 = $filasHA_c[0]['d20_cares_c'] + $filasHA_c[1]['d20_cares_c'] +$filasHA_c[1]['d20_cares_c'] +$filasHA_c[2]['d20_cares_c'] +$filasHA_c[4]['d20_cares_c'];
$sumCold25 = $filasHA_c[0]['d25_cares_c'] + $filasHA_c[1]['d25_cares_c'] +$filasHA_c[1]['d25_cares_c'] +$filasHA_c[2]['d25_cares_c'] +$filasHA_c[4]['d25_cares_c'];
$sumCold32 = $filasHA_c[0]['d32_cares_c'] + $filasHA_c[1]['d32_cares_c'] +$filasHA_c[1]['d32_cares_c'] +$filasHA_c[2]['d32_cares_c'] +$filasHA_c[4]['d32_cares_c'];
$sumCold40 = $filasHA_c[0]['d40_cares_c'] + $filasHA_c[1]['d40_cares_c'] +$filasHA_c[1]['d40_cares_c'] +$filasHA_c[2]['d40_cares_c'] +$filasHA_c[4]['d40_cares_c'];
...
$sumCold8 = ($filasHA_c[1]['d8_cares_c'] * $filasHA_c[1]['peso_d8']) + ($filasHA_c[1]['d8_cares_c'] * $filasHA_c[1]['peso_d8']) + ($filasHA_c[2]['d8_cares_c'] * $filasHA_c[2]['peso_d8']) + ($filasHA_c[4]['d8_cares_c'] * $filasHA_c[4]['peso_d8']) ;
$sumCold10 = ($filasHA_c[1]['d10_cares_c'] * $filasHA_c[1]['peso_d10']) + ($filasHA_c[1]['d10_cares_c'] * $filasHA_c[1]['peso_d10']) + ($filasHA_c[2]['d10_cares_c'] * $filasHA_c[2]['peso_d10']) + ($filasHA_c[4]['d10_cares_c'] * $filasHA_c[4]['peso_d10']) ;
$sumCold12 = ($filasHA_c[1]['d12_cares_c'] * $filasHA_c[1]['peso_d12']) + ($filasHA_c[1]['d12_cares_c'] * $filasHA_c[1]['peso_d12']) + ($filasHA_c[2]['d12_cares_c'] * $filasHA_c[2]['peso_d12']) + ($filasHA_c[4]['d12_cares_c'] * $filasHA_c[4]['peso_d12']) ;
$sumCold14 = ($filasHA_c[1]['d14_cares_c'] * $filasHA_c[1]['peso_d14']) + ($filasHA_c[1]['d14_cares_c'] * $filasHA_c[1]['peso_d14']) + ($filasHA_c[2]['d14_cares_c'] * $filasHA_c[2]['peso_d14']) + ($filasHA_c[4]['d14_cares_c'] * $filasHA_c[4]['peso_d14']) ;
$sumCold16 = ($filasHA_c[1]['d16_cares_c'] * $filasHA_c[1]['peso_d16']) + ($filasHA_c[1]['d16_cares_c'] * $filasHA_c[1]['peso_d16']) + ($filasHA_c[2]['d16_cares_c'] * $filasHA_c[2]['peso_d16']) + ($filasHA_c[4]['d16_cares_c'] * $filasHA_c[4]['peso_d16']) ;
$sumCold20 = ($filasHA_c[1]['d20_cares_c'] * $filasHA_c[1]['peso_d20']) + ($filasHA_c[1]['d20_cares_c'] * $filasHA_c[1]['peso_d20']) + ($filasHA_c[2]['d20_cares_c'] * $filasHA_c[2]['peso_d20']) + ($filasHA_c[4]['d20_cares_c'] * $filasHA_c[4]['peso_d20']) ;
$sumCold25 = ($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']) + ($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']) + ($filasHA_c[2]['d25_cares_c'] * $filasHA_c[2]['peso_d25']) + ($filasHA_c[4]['d25_cares_c'] * $filasHA_c[4]['peso_d25']) ;
$sumCold32 = ($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']) + ($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']) + ($filasHA_c[2]['d32_cares_c'] * $filasHA_c[2]['peso_d32']) + ($filasHA_c[4]['d32_cares_c'] * $filasHA_c[4]['peso_d32']) ;
$sumCold40 = ($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']) + ($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']) + ($filasHA_c[2]['d40_cares_c'] * $filasHA_c[2]['peso_d40']) + ($filasHA_c[4]['d40_cares_c'] * $filasHA_c[4]['peso_d40']) ;
$totalFila = 0; 
$totalFila =  $sumCold8 + $sumCold10 + $sumCold12 + $sumCold14 + $sumCold16+ $sumCold20+ $sumCold25+ $sumCold32+ $sumCold40;
$totalBarras = $totalFila;
...
$pdf->SetFont('Helvetica','',9);
$pdf->Cell(74,4,utf8_decode('BARRAS 12 M'),'LTBR',0,'R');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d8_cares_c'] * $filasHA_c[1]['peso_d8']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d10_cares_c'] * $filasHA_c[1]['peso_d10']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d12_cares_c'] * $filasHA_c[1]['peso_d12']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d14_cares_c'] * $filasHA_c[1]['peso_d14']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d16_cares_c'] * $filasHA_c[1]['peso_d16']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d20_cares_c'] * $filasHA_c[1]['peso_d20']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']),'LTBR',0,'C');
$pdf->Cell(17,4,utf8_decode($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']),'LTBR',0,'C');

$totalFila =  
($filasHA_c[1]['d8_cares_c'] * $filasHA_c[1]['peso_d8']) +
($filasHA_c[1]['d10_cares_c'] * $filasHA_c[1]['peso_d10']) +
($filasHA_c[1]['d12_cares_c'] * $filasHA_c[1]['peso_d12']) +
($filasHA_c[1]['d14_cares_c'] * $filasHA_c[1]['peso_d14']) +
($filasHA_c[1]['d16_cares_c'] * $filasHA_c[1]['peso_d16']) +
($filasHA_c[1]['d20_cares_c'] * $filasHA_c[1]['peso_d20']) +
($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']) +
($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']) +
($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']);
...
$sumCold25 = ($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']) + ($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']) + ($filasHA_c[2]['d25_cares_c'] * $filasHA_c[2]['peso_d25']) + ($filasHA_c[4]['d25_cares_c'] * $filasHA_c[4]['peso_d25']) ;
$sumCold32 = ($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']) + ($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']) + ($filasHA_c[2]['d32_cares_c'] * $filasHA_c[2]['peso_d32']) + ($filasHA_c[4]['d32_cares_c'] * $filasHA_c[4]['peso_d32']) ;
$sumCold40 = ($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']) + ($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']) + ($filasHA_c[2]['d40_cares_c'] * $filasHA_c[2]['peso_d40']) + ($filasHA[4]['d40_cares_c'] * $filasHA[4]['peso_d40']) ;
$totalFila = 0; 
$totalFila = $sumCold6 + $sumCold8 + $sumCold9 + $sumCold10 + $sumCold12 + $sumCold14 + $sumCold16+ $sumCold20+ $sumCold25+ $sumCold32+ $sumCold40;
...
//CALCULO SUMATORIOS COLUMNA
$sumCold8 = ($filasHA_c[0]['d8_cares_c'] * $filasHA_c[0]['peso_d8']) + ($filasHA_c[1]['d8_cares_c'] * $filasHA_c[1]['peso_d8']) + ($filasHA_c[1]['d8_cares_c'] * $filasHA_c[1]['peso_d8']) + ($filasHA_c[2]['d8_cares_c'] * $filasHA_c[2]['peso_d8']) + ($filasHA_c[4]['d8_cares_c'] * $filasHA_c[4]['peso_d8']) ;
$sumCold10 = ($filasHA_c[0]['d10_cares_c'] * $filasHA_c[0]['peso_d10']) + ($filasHA_c[1]['d10_cares_c'] * $filasHA_c[1]['peso_d10']) + ($filasHA_c[1]['d10_cares_c'] * $filasHA_c[1]['peso_d10']) + ($filasHA_c[2]['d10_cares_c'] * $filasHA_c[2]['peso_d10']) + ($filasHA_c[4]['d10_cares_c'] * $filasHA_c[4]['peso_d10']) ;
$sumCold12 = ($filasHA_c[0]['d12_cares_c'] * $filasHA_c[0]['peso_d12']) + ($filasHA_c[1]['d12_cares_c'] * $filasHA_c[1]['peso_d12']) + ($filasHA_c[1]['d12_cares_c'] * $filasHA_c[1]['peso_d12']) + ($filasHA_c[2]['d12_cares_c'] * $filasHA_c[2]['peso_d12']) + ($filasHA_c[4]['d12_cares_c'] * $filasHA_c[4]['peso_d12']) ;
$sumCold14 = ($filasHA_c[0]['d14_cares_c'] * $filasHA_c[0]['peso_d14']) + ($filasHA_c[1]['d14_cares_c'] * $filasHA_c[1]['peso_d14']) + ($filasHA_c[1]['d14_cares_c'] * $filasHA_c[1]['peso_d14']) + ($filasHA_c[2]['d14_cares_c'] * $filasHA_c[2]['peso_d14']) + ($filasHA_c[4]['d14_cares_c'] * $filasHA_c[4]['peso_d14']) ;
$sumCold16 = ($filasHA_c[0]['d16_cares_c'] * $filasHA_c[0]['peso_d16']) + ($filasHA_c[1]['d16_cares_c'] * $filasHA_c[1]['peso_d16']) + ($filasHA_c[1]['d16_cares_c'] * $filasHA_c[1]['peso_d16']) + ($filasHA_c[2]['d16_cares_c'] * $filasHA_c[2]['peso_d16']) + ($filasHA_c[4]['d16_cares_c'] * $filasHA_c[4]['peso_d16']) ;
$sumCold20 = ($filasHA_c[0]['d20_cares_c'] * $filasHA_c[0]['peso_d20']) + ($filasHA_c[1]['d20_cares_c'] * $filasHA_c[1]['peso_d20']) + ($filasHA_c[1]['d20_cares_c'] * $filasHA_c[1]['peso_d20']) + ($filasHA_c[2]['d20_cares_c'] * $filasHA_c[2]['peso_d20']) + ($filasHA_c[4]['d20_cares_c'] * $filasHA_c[4]['peso_d20']) ;
$sumCold25 = ($filasHA_c[0]['d25_cares_c'] * $filasHA_c[0]['peso_d25']) + ($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']) + ($filasHA_c[1]['d25_cares_c'] * $filasHA_c[1]['peso_d25']) + ($filasHA_c[2]['d25_cares_c'] * $filasHA_c[2]['peso_d25']) + ($filasHA_c[4]['d25_cares_c'] * $filasHA_c[4]['peso_d25']) ;
$sumCold32 = ($filasHA_c[0]['d32_cares_c'] * $filasHA_c[0]['peso_d32']) + ($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']) + ($filasHA_c[1]['d32_cares_c'] * $filasHA_c[1]['peso_d32']) + ($filasHA_c[2]['d32_cares_c'] * $filasHA_c[2]['peso_d32']) + ($filasHA_c[4]['d32_cares_c'] * $filasHA_c[4]['peso_d32']) ;
$sumCold40 = ($filasHA_c[0]['d40_cares_c'] * $filasHA_c[0]['peso_d40']) + ($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']) + ($filasHA_c[1]['d40_cares_c'] * $filasHA_c[1]['peso_d40']) + ($filasHA_c[2]['d40_cares_c'] * $filasHA_c[2]['peso_d40']) + ($filasHA_c[4]['d40_cares_c'] * $filasHA_c[4]['peso_d40']) ;
$totalFila = 0; 
$totalFila = $sumCold6 + $sumCold8 + $sumCold9 + $sumCold10 + $sumCold12 + $sumCold14 + $sumCold16+ $sumCold20+ $sumCold25+ $sumCold32+ $sumCold40;
